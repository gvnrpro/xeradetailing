...
const LeadCapturePopup = ({ 
  ...
  useEffect(() => {
    if (!isMobile || hasDismissed) return;
  ...
  }, [delay, scrollTrigger, isVisible, hasDismissed, isMobile]);
  ...
  if (!isMobile || hasDismissed) return null;
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <motion.div 
            className="bg-gradient-to-b from-xera-darkgray to-black rounded-lg border border-white/20 shadow-xl max-w-md w-full overflow-hidden"
          ...
          >
            <div className="relative">
              ...
              <div className="bg-gradient-to-r from-xera-red to-red-700 p-4 text-center">
                <h3 className="font-bold text-xl text-white">₹500 OFF Ceramic Coating</h3>
                <p className="text-white/90 text-sm">Limited Time Offer - Book Now!</p>
              </div>
