...
const LimitedOfferModal = () => {
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          className="fixed bottom-4 md:bottom-6 left-1/2 transform -translate-x-1/2 z-40 max-w-sm w-full md:max-w-md"
          initial={{ y: 100, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          exit={{ y: 100, opacity: 0 }}
          transition={{ duration: 0.4 }}
        >
          <div className="bg-gradient-to-r from-red-900 to-xera-red p-1 rounded-lg shadow-xl">
            <div className="bg-xera-darkgray rounded-md p-4 relative">
              <button 
              ...
              <div className="text-center mb-4">
                <h3 className="font-bold text-xl mb-1">This Week Only: 10% OFF Ceramic Coating!</h3>
                <p className="text-white/70 text-sm">Limited availability. Book your ceramic coating now to lock in this exclusive price!</p>
              </div>
